...
from App.controllers.routine import create_routine, get_routine, get_all_routines, get_user_routines, add_workout_to_routine, delete_routine, remove_workout_from_routine,update_routine
...
def view_routine_page(routine_id):
    ...
    return render_template('routine.html', workouts=workout_data,routine=routine)
